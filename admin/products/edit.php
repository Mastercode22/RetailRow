...
<head>
    ...
    <title>Edit Product - RetailRow Admin</title>
            ...
            <form method="POST" enctype="multipart/form-data">
                ...
                <div class="price-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="old_price" name="old_price" step="0.01" min="0" value="<?php echo htmlspecialchars($product['old_price']); ?>">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <?php if ($product['image']): ?>
                        <p>Current image: <a href="../../<?php echo htmlspecialchars($product['image']); ?>" target="_blank"><?php echo htmlspecialchars($product['image']); ?></a></p>
                    <?php endif; ?>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="checkbox-group">
                        ...
                        <label class="checkbox-item">
                            <input type="checkbox" name="is_flash_sale" value="1" <?php echo $product['is_flash_sale'] ? 'checked' : ''; ?>>
                            Flash Sale
                        </label>
                        <label class="checkbox-item">
